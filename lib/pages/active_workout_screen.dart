...
class _ActiveWorkoutScreenState extends ConsumerState<ActiveWorkoutScreen> {
                  ...
                  background: Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          theme.background,
                          theme.background.withOpacity(0.87),
                        ],
                      ),
                    ),
                    child: SafeArea(
                          ...
                          Column(
                            children:
                                exercise.sets.asMap().entries.map((entry) {
                                  ...
                                  final weightKey =
                                      'w_${exerciseIndex}_$setIndex';
                                  final repsKey =
                                      'r_${exerciseIndex}_$setIndex';
                                  final notesKey =
                                      'n_${exerciseIndex}_$setIndex';
                                  final rirKey =
                                      'rir_${exerciseIndex}_$setIndex';
                                  ...
                                  final weightColor =
                                      edited.contains(weightKey)
                                          ? theme.text
                                          : theme.textSecondary;
                                  final repsColor =
                                      edited.contains(repsKey)
                                          ? theme.text
                                          : theme.textSecondary;
                                  final notesColor =
                                      edited.contains(notesKey)
                                          ? theme.text
                                          : theme.textSecondary;
                                  final rirColor =
                                      edited.contains(rirKey)
                                          ? theme.text
                                          : theme.textSecondary;
                                  ...
                                  return SwipeableSetRowNew(
                                    ...
                                    editedFields:
                                        ref.watch(workoutProvider).editedFields,
  ...
  Future<void> _showConfigureSetsDialog(String exerciseName) async {
    ...
    final TextEditingController warmUpController = TextEditingController(
      text: '0',
    );
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                ref
                    .read(workoutProvider.notifier)
                    .addExercise(exerciseName, sets: sets, warmUpSets: warmUp);
                Navigator.of(context).pop();
              },
            ...
            actions: [
              ...
              TextButton(
                onPressed: () async {
                  ...
                  await ref
                      .read(workoutProvider.notifier)
                      .saveActiveWorkoutAsTemplate(name, overwrite: false);
  ...
  Future<void> _updateOriginalTemplate() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder:
          (context) => AlertDialog(
            backgroundColor: theme.card,
            title: Text('Update Template', style: TextStyle(color: theme.text)),
            content: Text(
...
class _SwipeableSetRowNewState extends ConsumerState<SwipeableSetRowNew>
  ...
  void _handlePanEnd(DragEndDetails details) {
    ...
    final hasEnoughVelocity =
        horizontalVelocity > 100; // Mycket lägre tröskel för lättare trigga
    ...
    if (isHorizontalSwipe && (hasEnoughVelocity || hasEnoughDistance)) {
      ...
      final hasPlaceholders =
          ((ph[wKey] is num && (ph[wKey] as num) > 0) ||
    ...
    _offsetAnimation = Tween<double>(begin: _swipeOffset, end: 0.0).animate(
      CurvedAnimation(parent: _animationController, curve: Curves.easeOutCubic),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final swipeProgress = (offset.abs() / 80.0).clamp(
          0.0,
          1.0,
        ); // Anpassad till ny range
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow:
                    hasPlaceholders && swipeProgress > 0.1
                        ? [
                          BoxShadow(
                      ...
                      Expanded(
                        ...
                        child: _buildInputField(
                          ...
                          hintText:
                              (() {
                                final ph =
                                    ref.watch(workoutProvider).placeholders;
                                final v =
                                    ph['w_${widget.exerciseIndex}_${widget.setIndex}'];
                          ...
                          onChanged: (value) {
                            if (value.isEmpty) {
                              ref
                                  .read(workoutProvider.notifier)
                                  .unmarkFieldEdited(widget.weightKey);
                            } else {
                              widget.onFieldEdited(widget.weightKey);
                            }
                        ...
                        child: _buildInputField(
                          ...
                          hintText:
                              (() {
                                final ph =
                                    ref.watch(workoutProvider).placeholders;
                                final v =
                                    ph['r_${widget.exerciseIndex}_${widget.setIndex}'];
                                if (v is num && v > 0) return v.toString();
                                return '';
                              })(),
                          keyboardType: TextInputType.number,
                          ...
                          onChanged: (value) {
                            if (value.isEmpty) {
                              ref
                                  .read(workoutProvider.notifier)
                                  .unmarkFieldEdited(widget.repsKey);
                            } else {
                              widget.onFieldEdited(widget.repsKey);
                            }
                          ...
                          child: _buildInputField(
                            ...
                            hintText:
                                (() {
                                  final ph =
                                      ref.watch(workoutProvider).placeholders;
                                  final v =
                                      ph['rir_${widget.exerciseIndex}_${widget.setIndex}'];
                                  if (v is num && v > 0) return v.toString();
                                  return '';
                                })(),
                            keyboardType: TextInputType.number,
                            ...
                            onChanged: (value) {
                              if (value.isEmpty) {
                                ref
                                    .read(workoutProvider.notifier)
                                    .unmarkFieldEdited(widget.rirKey);
                              } else {
                                widget.onFieldEdited(widget.rirKey);
                              }
                        ...
                        child: _buildInputField(
                          ...
                          hintText:
                              (() {
                                final ph =
                                    ref.watch(workoutProvider).placeholders;
                                final v =
                                    ph['n_${widget.exerciseIndex}_${widget.setIndex}'];
                          ...
                          onChanged: (value) {
                            if (value.isEmpty) {
                              ref
                                  .read(workoutProvider.notifier)
                                  .unmarkFieldEdited(widget.notesKey);
                            } else {
                              widget.onFieldEdited(widget.notesKey);
                            }
                            ref
  ...
  Widget? _buildProgressionIndicator(WidgetRef ref) {
    ...
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [indicators[0], const SizedBox(width: 6), indicators[1]],
    );
  }
